...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "ConnectSDK",
            url: "https://dl.cloudsmith.io/QQ43WPa2Y7VlFUM3/proglove/markconnectiossdk-prod/raw/names/ConnectSDK-2.4.0.xcframework/versions/2.4.0/ConnectSDK-2.4.0.xcframework.zip?accept_eula=7",
